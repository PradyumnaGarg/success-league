  ...
  team = [
    {
      ...
      descriptionArray: [
        ...
        'He has extensively represented companies in Civil Cases – Recovery suits (under order XXXVII CPC), Title suits, Injunctions, Arbitration matters, Execution of decrees and interim orders, Consumer cases & MIS progress and update of running cases as well as Criminal Cases – Negotiable Instruments cases (138 NI Act), Police Complaints, Criminal Complaints, 156(3) CRPC and Criminal Trials.',
        ...
        'He has earlier worked with Unigrow Ventures, SMC Group of Companies, Unicorn Securities and R.R. Financial Consultants Ltd. in senior capacities such as that of Asst. Vice President, where he has worked for clients like- State Bank of India, India Infoline, Prudential Wealth Advisors Pvt. Ltd., E-Revbay Pvt. Ltd., Gulf Hub, Destimoney Insurance etc.'
      ]
    },
    {
      id: 'vivek-garg',
